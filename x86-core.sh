...
# sed -i '$a src-git cups https://github.com/fenkail-ui/luci-app-cupsd.git' feeds.conf.default
...
git clone https://github.com/fenkail-ui/x86.git
\cp -rf x86 ./target/linux/
rm -rf x86
